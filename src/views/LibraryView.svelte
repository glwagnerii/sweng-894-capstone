<script lang="ts">
  ...
  const files: File[] = [
    ...
    },
    {
      ...
      ingredients: [
        { class: 'butter', score: 0.88, bbox: [20, 230, 170, 190] },
        { class: 'bell pepper', score: 0.65, bbox: [320, 210, 260, 230] },
        { class: 'mushrooms', score: 0.95, bbox: [760, 200, 390, 320] },
        { class: 'onions', score: 0.70, bbox: [1280, 50, 210, 290] },
        { class: 'shredded beef', score: 0.93, bbox: [410, 650, 400, 290] },
        { class: 'peppers', score: 0.74, bbox: [40, 810, 240, 210] },
        { class: 'cheese', score: 0.81, bbox: [1220, 840, 240, 210] },
        { class: 'bread', score: 0.77, bbox: [960, 610, 260, 410] },
      ],
    },
    {
      name: 'ingredients9.jpg',
      ingredients: [
        { class: 'salmon', score: 0.95, bbox: [150, 190, 200, 170] },
        { class: 'lemons', score: 0.65, bbox: [110, 480, 100, 70] },
        { class: 'potatoes', score: 0.89, bbox: [10, 280, 120, 100] },
        { class: 'mustard', score: 0.70, bbox: [260, 420, 70, 60] },
        { class: 'cherry tomatoes', score: 0.84, bbox: [10, 90, 130, 150] },
        { class: 'parsley', score: 0.74, bbox: [140, 410, 90, 80] },
        { class: 'feta cheese', score: 0.93, bbox: [230, 40, 90, 80] },
        { class: 'butter', score: 0.81, bbox: [110, 20, 90, 80] },
        { class: 'salt', score: 0.77, bbox: [20, 400, 70, 70] },
      ],
    },
  ]
  ...
  async function handleImageClick(file: { name: string, ingredients: Detection[] }) {
    ...
    const detections = (file.ingredients.length > 0) ? file.ingredients : await invoke('infer', { base64: base64stipped }) as Detection[]
